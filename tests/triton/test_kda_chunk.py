...
# Adapted for NPU (Triton-only) from tests/ops/test_kda_chunk.py
#
...
from fla.ops.triton.triton_core.utils import assert_close

# ---------------------------------------------------------------------------
# Device selection: NPU → CUDA → CPU fallback
# ---------------------------------------------------------------------------
